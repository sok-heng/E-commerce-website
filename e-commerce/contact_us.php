...
if (!isset($_SESSION['user_id'])) {
    ...
    // Check for success via query string (after redirect)
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($name && $email && $message) {
            $stmt = $conn->prepare("INSERT INTO contact_messages (user_id, name, email, message, phone) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param("issss", $user_id, $name, $email, $message, $phone);
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="grid lg:grid-cols-2 grid-cols-1 gap-x-24">
        ...
        <div class="flex items-center lg:mb-0 mb-10">
          <div>
            <h4 class="text-pink-400 text-base font-medium mb-4 lg:text-left text-center">Contact Us</h4>
            <h2 class="text-gray-900 text-4xl font-semibold mb-9 lg:text-left text-center">Reach Out To Us</h2>

            <!-- Message Display -->
            <?php if (!empty($success)): ?>
              <p id="successMessage" class="text-green-600 text-center mb-4"><?php echo $success; ?></p>
              <script>
                setTimeout(() => {
            ...
            <form action="" method="POST">
              <input type="text" name="name" required placeholder="Name"
                class="w-full h-14 shadow-sm text-gray-600 placeholder-text-400 text-lg rounded-full border border-gray-200 focus:outline-none py-2 px-4 mb-8"
              ...
              <textarea name="message" required placeholder="Phone or Message"
                class="w-full h-48 shadow-sm resize-none text-gray-600 placeholder-text-400 text-lg rounded-2xl border border-gray-200 focus:outline-none px-4 py-4 mb-8"><?php echo isset($message) ? htmlspecialchars($message) : ''; ?></textarea>

              <button type="submit"
                class="w-full h-12 text-center text-pink-400 border border-pink-400 text-base font-semibold rounded-full shadow transition-all duration-700 hover:bg-pink-400 hover:text-white">
                Submit
              </button>
            </form>
          </div>
        ...
        <!-- You can add your Image/Info Card here -->
 <!-- Image/Info Card Column -->
           <div class="lg:max-w-xl opacity-70 w-full h-[600px] flex items-center justify-center  bg-cover bg-no-repeat bg-[url('https://image.slidesdocs.com/responsive-images/slides/0-japanese-literature-and-art-general-work-debriefing-report-download-powerpoint-background_83511ee778__960_540.jpg')] ">
                <div class="">
                    <div class="lg:w-96 opacity-none w-auto h-auto bg-white shadow-xl lg:p-6 p-4">
                                         <div class="flex justify-center items-center text-center  mb-10">
    <img src="./picture/fulllogo_transparent.png" class=" rounded-3xl" width="100" height="33" alt="">
    <p class="text-lg "><span class="text-pink-400">Bloom</span>Skin</p>
</div>
                        ...
                        <a href="javascript:;" class="flex items-center mb-6">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">Bloomskin@gmail.com</h5>
                        </a>
                        <a href="javascript:;" class="flex items-center mb-6">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h5 class="text-black text-base font-normal leading-6 ml-5">54 St 606, Phnom Penh</h5>
                        </a>
